...
const AuthCard: FC<IAuthCard> = ({ children, goBack }) => {
  return (
    <section className="flex h-full w-full flex-col items-center justify-center">
      <div className="grid h-full w-full md:grid-cols-12">
        <div className="relative hidden h-full w-full border-r border-gray-200 bg-[#F8F8F8] md:col-start-1 md:col-end-8 md:block md:max-h-[700px] md:rounded-l-lg md:p-10">
          <div className='h-full w-full absolute inset-0 bg-auth_illustration bg-no-repeat bg-center'/>
          <AppLogo />
        ...
        <div className="flex h-full max-h-[700px] w-full flex-col md:col-start-8 md:col-end-13 md:rounded-br-lg md:rounded-tr-lg md:bg-white md:py-10">
          <div className="flex items-center gap-2 p-6 text-white md:hidden">
            <ArrowLeft2
